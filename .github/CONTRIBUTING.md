...
Firstly thank you for your interest in contributing to _mvdef_!
...
Next get the latest checkout of the _mvdef_ repository:

```sh
git clone git@github.com:lmmx/mvdef.git
```

Change into the newly created directory and **after activating your virtual environment**
install an editable version of mvdef along with its tests requirements:
...
Thank you for considering contribution to _mvdef_!
